...
<div class="card">
    <div class="card-body">
        <form id="templateForm" method="POST" action="{{ route('templates.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('page_size') is-invalid @enderror" id="page_size" name="page_size">
                        <option value="A4" {{ old('page_size', 'A4') === 'A4' ? 'selected' : '' }}>A4</option>
                        <option value="A5" {{ old('page_size') === 'A5' ? 'selected' : '' }}>A5</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('margin_left') is-invalid @enderror" 
                           id="margin_left" name="margin_left" value="{{ old('margin_left', 25) }}" 
                           min="0" max="100" step="0.1">
                    @error('margin_left')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" class="form-control @error('margin_right') is-invalid @enderror" 
                           id="margin_right" name="margin_right" value="{{ old('margin_right', 25) }}" 
                           min="0" max="100" step="0.1">
                    @error('margin_right')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="col-md-6">
                    ...
                    @error('header_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div id="headerPreview" class="mt-2"></div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    @error('footer_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <div id="footerPreview" class="mt-2"></div>
                </div>
